var categoryLocation = '/faq/_design/FAQcouch/_view/categories?reduce=false';
    	...
    	documentReq.onreadystatechange = function() {
    		if (documentReq.readyState === 4 && documentReq.status == 200) {
    			...
    			if (!!response.category) {
        			categoryList = response.category; //documents categories
        			var categoriesReq = new XMLHttpRequest();
        			categoriesReq.open('GET',categoryLocation);
